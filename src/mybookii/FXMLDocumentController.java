...
public class FXMLDocumentController {
    ...
    @FXML private TableView<Recordings> tableView;
    @FXML private TableView<Recordings> entrieName;
    @FXML private TableView<Recordings> entrieMark;
    @FXML private TableView<Recordings> entrieDelete;

    private final ObservableList<Recordings> data = FXCollections.observableArrayList();
    ...
    @FXML private void markFile() { System.out.println("it works");}
    @FXML private void startRecording() { System.out.println("it works");}
